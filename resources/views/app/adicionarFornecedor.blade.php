...
@section('conteudo')
    ...
    <div class="space-y-8">
        ...
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-900/50 rounded-2xl shadow-lg p-8">
            ...
            <form action="{{ route('app.fornecedor.guardar') }}" method="post" class="space-y-6" novalidate>
                @csrf
                ...
                <div>
                    <label for="site" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Site</label>
                    <input id="site" name="site" value="{{ old('site') }}" type="text"
                           class="mt-1 w-full p-3 rounded-md bg-gray-200 dark:bg-gray-700 border border-transparent focus:outline-none focus:ring-2 focus:ring-primary transition dark:focus:ring-secondary transition">
                </div>

                <div>
                    <label for="uf" class="block text-sm font-medium text-gray-700 dark:text-gray-300">UF (Estado)</label>
                    <input id="uf" name="uf" value="{{ old('uf') }}" type="text"
                           class="mt-1 w-full p-3 rounded-md bg-gray-200 dark:bg-gray-700 border border-transparent focus:outline-none focus:ring-2 focus:ring-primary transition dark:focus:ring-secondary transition">
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    ...
                    <a href="{{ route('app.fornecedor') }}" class="w-full text-center py-3 px-6 font-semibold text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-700 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                        Cancelar
                    </a>
                </div>
            </form>
