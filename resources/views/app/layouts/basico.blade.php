            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-6">
                    <nav class="hidden md:flex items-center space-x-6">
                        <a href="{{ route('app.home') }}" class="hover:text-primary transition-colors dark:hover:text-secondary transition-colors">Home</a>
                        <a href="{{ route('app.cliente') }}" class="hover:text-primary transition-colors dark:hover:text-secondary transition-colors">Cliente</a>
                        <a href="{{ route('app.fornecedor') }}" class="hover:text-primary transition-colors dark:hover:text-secondary transition-colors">Fornecedor</a>
                        <a href="{{ route('app.produto') }}" class="hover:text-primary transition-colors dark:hover:text-secondary transition-colors">Produto</a>
                        <a href="{{ route('app.sair') }}" class="hover:text-primary transition-colors dark:hover:text-secondary transition-colors">Sair</a>
                    </nav>
