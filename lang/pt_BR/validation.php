...
return [
    ...
    | as regras de tamanho. Sinta-se à vontade para ajustar cada uma destas mensagens aqui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O valor informado para o campo :attribute apareceu em um vazamento de dados. Por favor, escolha um :attribute diferente.',
    ],
    ...
    | especificar rapidamente uma linha de idioma personalizada para uma determinada regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nosso placeholder de atributo
    | por algo mais amigável, como "Endereço de E-Mail" em vez de
